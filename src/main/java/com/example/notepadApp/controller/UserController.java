...
import com.example.notepadApp.exceptions.IncorrectPasswordException;
...
public class UserController {
    ...
    ResponseEntity<?> loginUser(@RequestBody User user) {
        ...
        User registeredUser = userService.findUserByEmail(user.getEmail()).orElseThrow(() -> new EntityNotFoundException("Not found User"));
